/**
 ...
 export default class Preview extends React.Component {
   ...
   insertCard(item, hoverIndex, hoverElement) {
     console.log('insert');
     ...
     this.saveData(item, hoverIndex, hoverIndex, hoverElement,'insert')
   }
 
   moveCard(dragIndex, hoverIndex, hoverElement) {
    console.log('move');
     const { data } = this.state
     const dragCard = data[dragIndex]
     this.saveData(dragCard, dragIndex, hoverIndex, hoverElement,'move')
     //move from outside to accordion
     //from accordion to outside
   }
  ...
  saveData(dragCard, dragIndex, hoverIndex, hoverElement, origin) {
    var newData = "";
    //console.log("dragCard",dragCard);
    //console.log("dragIndex",dragIndex);
    //console.log("stateData",this.state.data);
    //console.log("hoverIndex",hoverIndex);
    //console.log("hoveredData",this.state.data[hoverIndex]);
    //console.log("HoverItemElement",hoverElement);
    //console.log(this.state);
    if (hoverElement === "AccordionSection"){
      this.state.data[hoverIndex].components.push(dragCard);
