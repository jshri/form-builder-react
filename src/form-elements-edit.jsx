...
export default class FormElementsEdit extends React.Component {
  ...
  editElementPropValue(elemProperty, targPropertyValue, e) {
    let this_element = this.state.element;
    ...
    this.setState({
      ...
      () => {
        if (targPropertyValue) {this.updateElement();};
      }
    );
  }
  ...
  render() {
    ...
    let this_checked_data_source = this.props.element.hasOwnProperty('data_source') ? this.props.element.data_source : 'SPSiteUsersList'; 
    ...
    return (
      <div>
        ...
        <Tabs defaultActiveKey={1} id="elementsProperties">
          <Tab eventKey={1} title="General">
            ...
            { this.props.element.hasOwnProperty('helpText') &&
              <div className="form-group">
                <input type="text" className="form-control" defaultValue={this.props.element.helpText} onBlur={this.updateElement.bind(this)} onChange={this.editElementProp.bind(this, 'helpText', 'value')} />
              </div>
            }
            { this.props.element.hasOwnProperty('canHaveTooltip') &&
              <div className="form-group">
                <label>Tooltip</label>
                <input type="text" className="form-control" defaultValue={this.props.element.toolTip} onBlur={this.updateElement.bind(this)} onChange={this.editElementProp.bind(this, 'toolTip', 'value')} />
              </div>
            }
          </Tab>
          <Tab eventKey={2} title="Data">
            { this.props.element.hasOwnProperty('datakey') &&
              <div className="form-group">
                <label className="control-label">Key:</label>
                <input type="text" className="form-control" defaultValue={this.props.element.dataKey} onBlur={this.updateElement.bind(this)} onChange={this.editElementProp.bind(this, 'dataKey', 'value')} />
              </div>
            }
            ...
            { (this.state.element.element === 'PeoplePicker'  &&  this.props.element.hasOwnProperty('data_source')) &&
              <div className="radio">
                <div><label>Source</label></div>
                <div>
                  <label className="normal">
                    <input name="peopleSource" type="radio" checked={this_checked_data_source === 'SPPeoplePicker'} value="SPPeoplePicker" onChange={this.editElementPropValue.bind(this, 'data_source', 'SPPeoplePicker')}/>
                    Native SharePoint People Picker
                  </label>
                </div>
                <div>
                  <label className="normal">
                    <input name="peopleSource"  type="radio" checked={this_checked_data_source === 'SPSiteUsersList'} value="SPSiteUsersList" onChange={this.editElementPropValue.bind(this, 'data_source', 'SPSiteUsersList')}/>
                ...
                <div>
                  <label className="normal">
                    <input name="peopleSource" type="radio" checked={this_checked_data_source === 'SPCustomList'} value="SPCustomList" onChange={this.editElementPropValue.bind(this, 'data_source', 'SPCustomList')}/>
                    Custom List
                  </label>
                </div>
            ...
            { (this.state.element.element === 'PeoplePicker'  &&  this.props.element.hasOwnProperty('data_source') && this_checked_data_source === 'SPCustomList') &&
              <div className="form-group">
                <input type="text" className="form-control"  placeholder="source site" />
                <input type="text" className="form-control"  placeholder="source list" />
                <input type="text" className="form-control"  placeholder="filter condition" />
                <input type="text" className="form-control"  placeholder="data field" />
              </div>
            }
          </Tab>
