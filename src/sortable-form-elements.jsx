...
import {Header,Paragraph,Label,LineBreak,TextInput,NumberInput,TextArea,Dropdown,Checkboxes,DatePicker,RadioButtons,Image,Rating,Tags,Signature,HyperLink,Download,Camera,Range,AccordionSection, PeoplePicker} from './form-elements';
...
FormElements.AccordionSection = SortableElement(AccordionSection);
FormElements.PeoplePicker = SortableElement(PeoplePicker);
