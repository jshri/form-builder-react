...
const cardTarget = {
	hover(props, monitor, component) {
		...
		const hoverElement = props.data ? props.data.element : "";
		//console.log("Hover Element Prop", props);
		// Don't replace items with themselves
		if (dragIndex === hoverIndex) {
			return
		} if (dragIndex === -1) {
			item.index = hoverIndex
			props.insertCard(item.onCreate(item.data), hoverIndex, hoverElement)
		}
		...
		props.moveCard(dragIndex, hoverIndex, hoverElement)
