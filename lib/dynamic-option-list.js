            ...
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'div',
                  { className: 'col-sm-6' },
                  _react2.default.createElement('input', { tabIndex: index + 1, className: 'form-control', style: { width: '100%' }, type: 'text', name: 'text_' + index, placeholder: 'Option text', value: option.text, onBlur: _this2.updateOption.bind(_this2), onChange: _this2.editOption.bind(_this2, index) })
                ),
                _react2.default.createElement(
                  'div',
                  { className: 'col-sm-2' },
                  _react2.default.createElement('input', { className: 'form-control', type: 'text', name: 'value_' + index, value: val, onChange: _this2.editValue.bind(_this2, index) })
                ),
                _react2.default.createElement(
                  'div',
                  { className: 'col-sm-1' },
                  _react2.default.createElement('input', { className: 'form-control', type: 'checkbox', value: '1', onChange: _this2.editOptionCorrect.bind(_this2, index), checked: option.hasOwnProperty("correct") })
                ),
                _react2.default.createElement(
                  'div',
                  { className: 'col-sm-3' },
                  _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                      'button',
                      { onClick: _this2.addOption.bind(_this2, index), className: 'btn btn-success' },
                      _react2.default.createElement('i', { className: 'fa fa-plus-circle' })
                    ),
                    index > 0 && _react2.default.createElement(
                      'button',
                      { onClick: _this2.removeOption.bind(_this2, index), className: 'btn btn-danger' },
